            ...
            <div class="event-card" style="background-image: url('event2.jpg');">
                <div class="overlay">
                    <div class="content">
                        ...
                        <p>Time: 7:00 PM</p>
                        <p>Venue: Event Hall 2, City</p>
                    </div>
                </div>
            </div>
          <%--  <div class="event-card" style="background-image: url('event3.jpg');">
                <div class="overlay">
                    <div class="content">
                        <h2>Event Title 3</h2>
                        <p>Date: July 25, 2024</p>
                        <p>Time: 5:00 PM</p>
                        <p>Venue: Event Hall 3, City</p>
                    </div>
                </div>
            </div>
            <div class="event-card" style="background-image: url('event4.jpg');">
                <div class="overlay">
                    <div class="content">
                        <h2>Event Title 4</h2>
                        <p>Date: July 28, 2024</p>
                        <p>Time: 8:00 PM</p>
                        <p>Venue: Event Hall 4, City</p>
                    </div>
                </div>
            </div>--%>
        </div>
