<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="EVENTnational.aspx.cs" Inherits="COD.National_Workshop_Varanasi_2022" %>
  ...
  @media (min-width:488px) {
    ...
    <nav aria-label="breadcrumb" style="padding: 0px 10px 0px 10px;">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">National Workshop</li>
        </ol>
    </nav>
            ...
            <div class="d-flex justify-content-center" style="background: #fff; padding-top: 10px;">
                ...
                <h3 class="headtitle " data-aos="fade-in">National Workshop on Strengthening Cause of Death Data Quality at M.P.M.M.C.C, Mini Auditorium, Varanasi on 16th & 17th December 2022</h3>
                <br />
            </div>
            <br />
    ...
    <a  class="snipcss0-6-48-49 snipcss-y928D  col-md-3 col-sm-12">
        <div class="card">
    <div class="img">
      <img src="assets/img/events/past/national-woskshop/25.jfif" alt="image">
    </div>
    ...
    <a class="snipcss0-6-48-49 snipcss-y928D col-md-3 col-sm-12">
                <div class="card ">
    <div class="img">
      <img src="assets/img/events/past/national-woskshop/26.jfif" alt="image">
    </div>
    ...
    <a class="snipcss0-6-48-49 snipcss-y928D col-md-3 col-sm-12">
                      <div class="card ">
    <div class="img">
      <img src="assets/img/events/past/national-woskshop/28.jfif" alt="image">
    </div>
