<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="EVENTInternational.aspx.cs" Inherits="COD.EVENT_International_1st_Workshop" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

      <style>
        .bodyratio { margin-top:194px; }
        section {
            width: 100%;
    ...
    <nav aria-label="breadcrumb" style="padding: 0px 10px 0px 10px;">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">International Workshop</li>
        </ol>
    </nav>
            ...
            <div class="d-flex justify-content-center" style="background: #fff; padding-top: 10px;">
                ...
                <h3 class="headtitle " data-aos="fade-in">1st International Workshop
      on Strengthening Cause of Death Data Quality
      10th December 2022</h3>
                <br />
            </div>
            <br />
    ...
    <a  class="snipcss0-6-48-49 snipcss-y928D col-md-3 col-sm-12">
                       <div class="card ">
    <div class="img">
     <img src="assets/img/events/past/international-woskshop/2.jfif" alt="image">
    </div>
                   ...
                   <a  class="snipcss0-6-48-49 snipcss-y928D col-md-3 col-sm-12">
                       <div class="card ">
    <div class="img">
     <img src="assets/img/events/past/international-woskshop/25.jfif" alt="image">
    </div>
  <%--  <span>
USCOD Launch</span>--%>
</div>
    ...
    <a class="snipcss0-6-48-49 snipcss-y928D col-md-3 col-sm-12">
                      <div class="card ">
    <div class="img">
      <img src="assets/img/events/past/international-woskshop/26.jfif" alt="image">
    </div>
   <%-- <span>General Training</span>--%>
                   ...
                   <a  class="snipcss0-6-48-49 snipcss-y928D col-md-3 col-sm-12">
                      <div class="card ">
    <div class="img">
       <img src="assets/img/events/past/international-woskshop/Sam_Notzon.jfif" alt="image">
    </div>
    <%--<span>Bihar</span>--%>
</div>
    </a>
