<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="EVENTodisha.aspx.cs" Inherits="COD.EVENTodisha" %>
...
@media (min-width:488px) {
    ...
    <nav aria-label="breadcrumb" style="padding: 0px 10px 0px 10px;">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Odisha Event</li>
        </ol>
    </nav>
          ...
          <h3 class="headtitle " data-aos="fade-in">Odisha Event</h3>
          <br />
      </div>
            <br />
                        <div class="content">
                   ...
                   <div class="col-1" style="display: inline-block; width: auto;">
                    ...
                    <div class="col"><br />
                       <%-- <p><b>One Day MCCD Workshop at Mahamana Pandit Madan Mohan Malaviya Cancer Centre, Uttar Pradesh</b></p>--%>
                        ...
                        <p>USCOD trained 45 doctors from the Khordha district by organizing a one-day district-level training
program at Jatni on 4 th  October 2023.</p>
                    </div>
                </div>
            ...
            <div class="content">
                <div class="row">
                   <div class="col-1" style="display: inline-block; width: auto;">
                    ...
                    <div class="col"><br />
                       <%-- <p><b>One Day MCCD Workshop at Mahamana Pandit Madan Mohan Malaviya Cancer Centre, Uttar Pradesh</b></p>--%>
                        <p>A one-day district-level training program for 70 doctors was conducted at District Hospital, Odisha on
6 th  October 2023.</p>
                    </div>
                </div>
