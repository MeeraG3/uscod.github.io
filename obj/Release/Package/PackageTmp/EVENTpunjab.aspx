<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="EVENTpunjab.aspx.cs" Inherits="COD.EVENTpunjab" %>
...
@media (min-width:488px) {
    ...
    <nav aria-label="breadcrumb" style="padding: 0px 10px 0px 10px;">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Punjab Event</li>
        </ol>
    </nav>
          ...
          <h3 class="headtitle " data-aos="fade-in">Punjab Event</h3>
          <br />
      </div>
            <br />
                        <div class="content">
                <div class="row">
                   <div class="col-1" style="display: inline-block; width: auto;">
                    ...
                    <div class="col"><br />
                       ...
                       <h4><b>MCCD Orientation training –</b></h4>
                        <p>A training for doctors of HBCH Sangrur and HBCHRC Mullanpur,
Punjab. The unit organized a MCCD orientation training for the doctors of the two Tata Memorial
Centers in Punjab- HBCH Sangrur and HBCHRC Mullanpur on 15 th March 2023. A total of 50 doctors
attended this training.</p>
                    </div>
                </div>
