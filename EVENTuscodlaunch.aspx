<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeBehind="EVENTuscodlaunch.aspx.cs" Inherits="COD.EVENTuscodlaunch" %>
...
@media (min-width:488px) {
    ...
    <nav aria-label="breadcrumb" style="padding: 0px 10px 0px 10px;">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">USCOD Launch</li>
        </ol>
    </nav>
    ...
    <a  class="snipcss0-6-48-49 snipcss-y928D  col-md-3 col-sm-12">
        <div class="card">
    <div class="img">
      <img src="assets/img/events/past/uscod-launch/codtemp1.jpg" alt="image">
    </div>
