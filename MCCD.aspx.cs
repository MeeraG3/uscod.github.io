...
namespace COD
{
    public partial class MCCD : System.Web.UI.Page
    {
        ...
        protected void Askexp_Click(object sender, EventArgs e)
        {

            HttpClient client = new HttpClient();
          //  client.BaseAddress = new Uri("http://10.100.75.76/Staff/");
            client.BaseAddress = new Uri("https://intranet.tmc.gov.in/uscod/");
            HttpResponseMessage response = client.GetAsync("api/USCODExpert/AskExpert?askexp=" + askexp.Text + "").Result;
